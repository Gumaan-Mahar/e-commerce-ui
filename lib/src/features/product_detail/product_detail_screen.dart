                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: widget.product.imageUrls.map((image) {
                            ...
                            return Container(
                              width: productDetailProvider.currentPageValue ==
                                      index
                                  ? 16.w
                                  : 6.w,
                              height: 6.h,
                              ...
                              decoration: BoxDecoration(
                                borderRadius:
                                    productDetailProvider.currentPageValue ==
                                            index
                                        ? BorderRadius.circular(
                                            4.0,
                                          )
                                        : null,
                                shape: productDetailProvider.currentPageValue ==
                                        index
                                    ? BoxShape.rectangle
                                    : BoxShape.circle,
                                color: productDetailProvider.currentPageValue ==
                                        index
                                    ? Colors.blue
                                    : Colors.grey,
                              ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ProductRatingsContainer(
                                    productRating: double.parse(widget
                                        .product.rating
                                        .toStringAsFixed(1)),
                                    totalRatings: 5,
